...
router.get("/", isAuth, isCoach, adminCoursesController.getOwnCourses);
...
router.get("/:courseId", isAuth, adminCoursesController.getCourseDetail);
router.put("/:courseId", isAuth, adminCoursesController.updateCourse);
